...
?>
        ...
        <table
            ...
            <tbody>
                <tr style="height: 113.575px;">
                    <img style="margin-top:20px; margin-right:-120px;  margin-left:-100px;" src="<?=base_url();?>assets/login/images/Logo.png" alt="" height="95" />
                    <td style="width: 470px; text-align: center; height: 113.575px; border: none;">

                        <h4 style="text-align: center; margin-bottom:-20px;">PT. Bringin Inti Teknologi</h4>
                        <h4 style="text-align: center; margin-bottom:-20px;">Departement Management</h4>

                        <h4 style="text-align: center; margin-bottom:-20px;">Divisi SDM</h4>
                        <h5 style="text-align: center; margin-bottom:10px;">Gedung Intiland
                        </h5>
                    </td>
                    <td>
                    </td>
    ...
    <!--   <p style="margin-bottom:-12px">Lampiran&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Bersama ini diterusakan usul cuti <?=$perihal_cuti?>
            pegawai PT. Bringin Inti Teknologi
            DKI Jakarta Jakarta Pusat, atas nama saudara:</p>
        <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            Nama &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <?=$nama_lengkap?></p>
        <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
